...
function remove_screen_options_tab() {        return current_user_can( 'manage_options' );   }   add_filter('screen_options_show_screen', 'remove_screen_options_tab');
...
function load_scripts() {
  if (!is_admin()) {
    ...
    $listing_pages = [
      'all-villas','property-results','villas-in-san-antonio','villas-in-ibiza-town',
      'villas-in-playa-den-bossa','villas-in-san-rafel','villas-in-san-josep',
      'villas-in-north-island','villas-rent-ibiza-12-guests','ibiza-villa-rental-10-22-guests'
    ];
...
function my_acf_google_map_api( $api ){
    $api['key'] = 'AIzaSyCepGyUv48UaiYx6A1gPqf9CENL0iSBvuM';
    return $api;
}
