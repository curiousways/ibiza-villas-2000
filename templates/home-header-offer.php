...
<div class="row" style="padding: 20px;">
	...
	<div class="column small-12 medium-12 large-4" style="padding-top: 20px;">
        <a style="width: 100%;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);" href="<?php echo $offer_villa['link']; ?>" class="button">CHECK <?php echo $offer_villa['name'];?> AND ENQUIRE NOW TO GET THE OFFER!</a>
    </div>

    <div class="column medium-4 large-12">
        <?php
        ...
        if ($villa_pretty_name) {
            ...
            echo '<p class="slider-location-sleeps">' . $offer_villa['sleeps'] .  '</p>';
            echo '<h4>Dates on offer:</h4>';

      } foreach($offer_villa['offers'] as $offer_date){
                echo '<h5>' .$offer_date['dates']. ' for just <span style="font-size: 350%; color:#ffc029; font-weight: 800;">&#163;' . $offer_date['price'] . '!</span></h5>';
            }
