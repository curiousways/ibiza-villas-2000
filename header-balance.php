    ...
    <header class="site-header">
        <div class="row full-width collapse">
            <div class="small-12 columns">
                <?php get_template_part('templates/nav', 'topbarbalance'); ?>
            </div>
        </div>

        <?php if (is_front_page()) { ?>
            <div class="row balance-hero-container">
                CLOCK
                <div class="medium-12 hero-title text-center columns">
                    <img class="hero-logo balance-hero-logo" src="<?php bloginfo('stylesheet_directory'); ?>/images/rudeibiza-logo-white.svg" alt="Ibiza Villas 2000">
                    <h1 class="balance-hero-title">Private Villas in Ibiza<br>Best Value Holiday Rental Villas</h1>
                </div>
            </div>
        <?php } ?>
    </header>
