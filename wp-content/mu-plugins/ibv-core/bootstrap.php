...
require_once IBV_CORE_PATH . 'includes/components/whatsapp-button/whatsapp-button.php';
...
require_once IBV_CORE_PATH . 'includes/sections/my-booking/my-booking.php';
